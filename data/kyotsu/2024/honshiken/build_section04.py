...
def main():
    ...
    if not section_data:
        print("Section 4 not found in kakomon 2024 data.")
        return
    ...
    # Add graph image reference to the appropriate passage
    # We will find the questionnaire passage and add the image to it later.
    ...
    sections = [s for s in honshiken_data.get('sections', []) if s.get('section_number') != 4]
    ...
    if 4 not in implemented:
        implemented.append(4)
        implemented.sort()
